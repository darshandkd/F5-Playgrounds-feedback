...
| **[AI Playground](https://playgrounds.darshandkd.com/ai-playground/)** | 30+ interactive simulations across **Inference** (9), **Safety & Security** (6 — including **AI Workflow Governance** powered by **SurePath AI**, F5's AI-access-governance gateway), and **Data Delivery** (5), plus **14** animated AI-concept explainers, an **AI Security** section (adversarial techniques + AI guardrails), and a catalog of F5's **AI product portfolio** (BIG-IP Next for Kubernetes, AI Guardrails, AI Red Team, SSL Orchestrator, and more) |
...
| **[XC Distributed Cloud](https://playgrounds.darshandkd.com/xc/)** | **F5 Distributed Cloud — now live and growing.** Interactive scenarios across **Multi-Cloud Networking** (App Connect — "connect apps, not networks" — and Service Mesh — identity, mTLS, policy & the service graph), **WAAP** (WAF attack signatures, API discovery & schema validation, L7 DDoS, web-app scanning), and **Bot Defense & Fraud** (adaptive bot defense, per-request signal detection, client-side / Magecart defense, authentication intelligence) — plus platform **Fundamentals** (Regional Edges, Customer Edges, the F5 Global Network). Modelled on the real XC mental model; more scenarios land regularly. |
